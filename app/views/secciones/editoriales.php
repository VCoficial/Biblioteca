        ...
        <div class="col-md-6 bg-dark border border-1 rounded  table-responsive ">
            ...
            <table id="mitabla" class="table table-dark table-hover  table-striped">
                <div class="d-flex justify-content-around ">
                    <a class="btn btn-danger" href="<?php echo URLROOT; ?>Editoriales/imprimirReporte" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" fill="currentColor" class="bi bi-file-earmark-pdf m-1" viewBox="0 0 16 16">
